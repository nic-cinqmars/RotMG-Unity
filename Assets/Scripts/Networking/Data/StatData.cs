...
namespace RotmgClient.Networking.Data
{
    public class StatData
    {
        ...
        public const int GLOW_COLOW_STAT = 59;
        ...
        // UNIMPLEMENTED
        public const int DAMAGE_MIN = 98;
        public const int DAMAGE_MAX = 99;
        public const int DAMAGE_MIN_BONUS = 100;
        public const int DAMAGE_MAX_BONUS = 101;
        public const int LUCK = 102;
        public const int RANK = 103;
        public const int ADMIN = 104;
        public const int LUCK_BONUS = 105;
